...
@ToolParserManager.register_module("exaone")
class ExaOneToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        self.tool_response_start_token: str = "<tool_response>"
        self.tool_response_end_token: str = "</tool_response>"

        self.tool_call_regex = re.compile(
            r"<tool_call>(.*?)</tool_call>|<tool_call>(.*)", re.DOTALL)
        self.tool_response_regex = re.compile(
        ...
        if (self.tool_call_start_token_id is None
            ...
            raise RuntimeError(
                "ExaOne Tool parser could not locate tool call start/end "
