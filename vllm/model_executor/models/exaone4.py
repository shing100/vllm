...
"""
vLLM용 EXAONE4 모델 구현 (HuggingFace EXAONE4, Qwen3 구조 참고)
"""
...
class Exaone4Attention(nn.Module):
    """
    EXAONE4의 Attention 레이어 (GQA, rotary, qk-norm 등 반영)
    """
    def __init__(
        self,
        hidden_size: int,
...
class Exaone4Model(Qwen2Model):
    """
    EXAONE4 모델 본체 (Qwen2Model 상속, 디코더 레이어만 변경)
    """
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__(vllm_config=vllm_config, prefix=prefix, decoder_layer_type=Exaone4DecoderLayer)


class Exaone4ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    """
    EXAONE4 언어모델 (CausalLM)
    """
